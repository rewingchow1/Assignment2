...
HD_PWD='/home/rewingchow/ECE1373_assignment2-2021_2017.2_optimized/8v3_shell/pr_region_test_proj/pr_region.runs/pr_region_2_fc_layer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pr_region_2_fc_layer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pr_region_2_fc_layer_0_0.tcl

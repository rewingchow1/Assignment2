...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_od \
    op interface \
    ports { od_dout { I 32 vector } od_empty_n { I 1 bit } od_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ix \
    op interface \
    ports { ix_dout { I 32 vector } ix_empty_n { I 1 bit } ix_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_iy \
    op interface \
    ports { iy_dout { I 32 vector } iy_empty_n { I 1 bit } iy_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ox \
    op interface \
    ports { ox_dout { I 32 vector } ox_empty_n { I 1 bit } ox_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_oy \
    op interface \
    ports { oy_dout { I 32 vector } oy_empty_n { I 1 bit } oy_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_k \
    op interface \
    ports { k_dout { I 32 vector } k_empty_n { I 1 bit } k_read { O 1 bit } } \
} "
}

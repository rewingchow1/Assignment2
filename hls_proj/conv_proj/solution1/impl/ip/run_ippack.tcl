...
set Library     "hls"
set IPName      "conv_layer"
set Version     "1.0"
set DisplayName "Conv_layer"
set Revision    "2103130116"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 input_offset W 0x0 "Data signal of input_offset" {{0 32 input_offset W 0 "Bit 31 to 0 Data signal of input_offset"}}} {0x18 output_offset W 0x0 "Data signal of output_offset" {{0 32 output_offset W 0 "Bit 31 to 0 Data signal of output_offset"}}} {0x20 b W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 31 to 0 Data signal of b"}}} {0x28 od W 0x0 "Data signal of od" {{0 32 od W 0 "Bit 31 to 0 Data signal of od"}}} {0x30 ox W 0x0 "Data signal of ox" {{0 32 ox W 0 "Bit 31 to 0 Data signal of ox"}}} {0x38 oy W 0x0 "Data signal of oy" {{0 32 oy W 0 "Bit 31 to 0 Data signal of oy"}}} {0x40 id W 0x0 "Data signal of id" {{0 32 id W 0 "Bit 31 to 0 Data signal of id"}}} {0x48 ix W 0x0 "Data signal of ix" {{0 32 ix W 0 "Bit 31 to 0 Data signal of ix"}}} {0x50 iy W 0x0 "Data signal of iy" {{0 32 iy W 0 "Bit 31 to 0 Data signal of iy"}}} {0x58 s W 0x0 "Data signal of s" {{0 32 s W 0 "Bit 31 to 0 Data signal of s"}}} {0x60 k W 0x0 "Data signal of k" {{0 32 k W 0 "Bit 31 to 0 Data signal of k"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4.000000 machine 64 combinational 0 latency 83 II x}
...
set enable_xo_gen 0
set kernel_files {/home/rewingchow/ECE1373_assignment2-2021_2017.2_optimized/conv_test/conv_layer.cpp}
if {$enable_xo_gen} {

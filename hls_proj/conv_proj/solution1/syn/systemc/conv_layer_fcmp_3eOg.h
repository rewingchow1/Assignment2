...
#ifndef __conv_layer_fcmp_3eOg__HH__
#define __conv_layer_fcmp_3eOg__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_layer_fcmp_3eOg) {
    ...
    SC_CTOR(conv_layer_fcmp_3eOg):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);

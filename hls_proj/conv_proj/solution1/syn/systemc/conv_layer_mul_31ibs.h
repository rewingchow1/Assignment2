...
#ifndef __conv_layer_mul_31ibs__HH__
#define __conv_layer_mul_31ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_layer_mul_31ibs) {
    ...
    SC_CTOR(conv_layer_mul_31ibs):  ACMP_mul_us_U ("ACMP_mul_us_U") {

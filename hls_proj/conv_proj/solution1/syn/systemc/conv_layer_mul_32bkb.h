...
#ifndef __conv_layer_mul_32bkb__HH__
#define __conv_layer_mul_32bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_layer_mul_32bkb) {
    ...
    SC_CTOR(conv_layer_mul_32bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {

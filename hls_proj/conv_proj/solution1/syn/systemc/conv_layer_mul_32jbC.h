...
#ifndef __conv_layer_mul_32jbC__HH__
#define __conv_layer_mul_32jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_layer_mul_32jbC) {
    ...
    SC_CTOR(conv_layer_mul_32jbC):  ACMP_mul_su_U ("ACMP_mul_su_U") {

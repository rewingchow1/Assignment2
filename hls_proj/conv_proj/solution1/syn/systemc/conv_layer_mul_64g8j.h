...
#ifndef __conv_layer_mul_64g8j__HH__
#define __conv_layer_mul_64g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_layer_mul_64g8j) {
    ...
    SC_CTOR(conv_layer_mul_64g8j):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

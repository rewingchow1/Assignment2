...
#ifndef __conv_layer_mul_96hbi__HH__
#define __conv_layer_mul_96hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_layer_mul_96hbi) {
    ...
    SC_CTOR(conv_layer_mul_96hbi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

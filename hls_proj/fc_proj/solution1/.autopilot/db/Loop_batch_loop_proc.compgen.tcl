...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { batch_size_dout { I 32 vector } batch_size_empty_n { I 1 bit } batch_size_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { num_outputs_dout { I 32 vector } num_outputs_empty_n { I 1 bit } num_outputs_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { num_inputs_dout { I 32 vector } num_inputs_empty_n { I 1 bit } num_inputs_read { O 1 bit } } \
} "
}

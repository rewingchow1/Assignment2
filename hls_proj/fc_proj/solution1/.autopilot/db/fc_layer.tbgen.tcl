set C_TypeInfoList {{ 
"fc_layer" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"mem": [[],{ "pointer":  {"scalar": "float"}}] }, {"input_offset": [[], {"scalar": "int"}] }, {"output_offset": [[], {"scalar": "int"}] }, {"batch_size": [["const"], {"scalar": "int"}] }, {"num_inputs": [["const"], {"scalar": "int"}] }, {"num_outputs": [["const"], {"scalar": "int"}] }, {"enable_relu": [["const"], {"scalar": "int"}] }],[],""]
}}
...
set C_modelArgList {
	...
	{ num_inputs int 32 regular {axi_slave 0}  }
	{ num_outputs int 32 regular {axi_slave 0}  }
	{ enable_relu int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "mem","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "batch_size", "interface" : "axi_slave", "bundle":"CTRL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "batch_size","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} , 
 	{ "Name" : "num_inputs", "interface" : "axi_slave", "bundle":"CTRL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "num_inputs","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":40}, "offset_end" : {"in":47}} , 
 	{ "Name" : "num_outputs", "interface" : "axi_slave", "bundle":"CTRL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "num_outputs","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":48}, "offset_end" : {"in":55}} , 
 	{ "Name" : "enable_relu", "interface" : "axi_slave", "bundle":"CTRL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "enable_relu","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":56}, "offset_end" : {"in":63}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_CTRL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CTRL_BUS", "role": "AWADDR" },"address":[{"name":"fc_layer","role":"start","value":"0","valid_bit":"0"},{"name":"fc_layer","role":"continue","value":"0","valid_bit":"4"},{"name":"fc_layer","role":"auto_start","value":"0","valid_bit":"7"},{"name":"input_offset","role":"data","value":"16"},{"name":"output_offset","role":"data","value":"24"},{"name":"batch_size","role":"data","value":"32"},{"name":"num_inputs","role":"data","value":"40"},{"name":"num_outputs","role":"data","value":"48"},{"name":"enable_relu","role":"data","value":"56"}] },
	...
	{ "name": "s_axi_CTRL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "CTRL_BUS", "role": "ARADDR" },"address":[{"name":"fc_layer","role":"start","value":"0","valid_bit":"0"},{"name":"fc_layer","role":"done","value":"0","valid_bit":"1"},{"name":"fc_layer","role":"idle","value":"0","valid_bit":"2"},{"name":"fc_layer","role":"ready","value":"0","valid_bit":"3"},{"name":"fc_layer","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "5", "13", "14", "15", "16", "17", "18", "19", "20"],
		"CDFG" : "fc_layer",
		...
		"VariableLatency" : "1",
		"InputProcess" : [
			{"ID" : "5", "Name" : "Loop_batch_loop_proc_U0", "ReadyCount" : "Loop_batch_loop_proc_U0_ap_ready_count"},
			{"ID" : "3", "Name" : "Block_proc4_U0", "ReadyCount" : "Block_proc4_U0_ap_ready_count"}],
		"OutputProcess" : [
			{"ID" : "5", "Name" : "Loop_batch_loop_proc_U0"}],
		"Port" : [
			{"Name" : "mem", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "Loop_batch_loop_proc_U0", "Port" : "mem"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc_layer_CTRL_BUS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc_layer_mem_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Block_proc4_U0", "Parent" : "0", "Child" : ["4"],
		"CDFG" : "Block_proc4",
		...
		"Port" : [
			...
			{"Name" : "output_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "batch_size", "Type" : "None", "Direction" : "I"},
			{"Name" : "num_outputs_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "5", "DependentChan" : "13",
				"BlockSignal" : [
					{"Name" : "num_outputs_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "num_inputs_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "5", "DependentChan" : "14",
				"BlockSignal" : [
					{"Name" : "num_inputs_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "batch_size_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "5", "DependentChan" : "15",
				"BlockSignal" : [
					{"Name" : "batch_size_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Block_proc4_U0.fc_layer_mul_32s_bkb_U1", "Parent" : "3"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_batch_loop_proc_U0", "Parent" : "0", "Child" : ["6", "7", "8", "9", "10", "11", "12"],
		...
		"VariableLatency" : "1",
		"Port" : [
			{"Name" : "batch_size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "15",
				"BlockSignal" : [
					{"Name" : "batch_size_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "num_outputs", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "13",
				"BlockSignal" : [
					{"Name" : "num_outputs_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "num_inputs", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "14",
				"BlockSignal" : [
					{"Name" : "num_inputs_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "20"},
			{"Name" : "mem", "Type" : "MAXI", "Direction" : "IO",
				"BlockSignal" : [
			...
			{"Name" : "p_read1", "Type" : "None", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "19"},
			{"Name" : "p_read2", "Type" : "None", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "16"},
			{"Name" : "p_read3", "Type" : "None", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "17"},
			{"Name" : "p_read4", "Type" : "None", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "18"}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_batch_loop_proc_U0.fc_layer_fadd_32ncud_U11", "Parent" : "5"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_batch_loop_proc_U0.fc_layer_fmul_32ndEe_U12", "Parent" : "5"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_batch_loop_proc_U0.fc_layer_fcmp_32neOg_U13", "Parent" : "5"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_batch_loop_proc_U0.fc_layer_mul_32nsfYi_U14", "Parent" : "5"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_batch_loop_proc_U0.fc_layer_mul_32s_g8j_U15", "Parent" : "5"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_batch_loop_proc_U0.fc_layer_mul_32s_g8j_U16", "Parent" : "5"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_batch_loop_proc_U0.fc_layer_mul_32s_g8j_U17", "Parent" : "5"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.num_outputs_channel_U", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.num_inputs_channel_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.batch_size_channel_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_2_loc_channel_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_1_loc_channel_U", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_3_loc_channel_U", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_4_loc_channel_U", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_6_loc_channel_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	fc_layer {
		...
		enable_relu {Type I LastRead 0 FirstWrite -1}}
	Block_proc4 {
		num_outputs {Type I LastRead 0 FirstWrite -1}
		num_inputs {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "49", "Max" : "659857415"}
	, {"Name" : "Interval", "Min" : "47", "Max" : "659857413"}
]}

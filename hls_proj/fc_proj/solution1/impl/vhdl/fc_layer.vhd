...
architecture behav of fc_layer is 
    ...
    "fc_layer,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu095-ffvc1517-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=1156392967,HLS_SYN_TPT=1156392965,HLS_SYN_MEM=2,HLS_SYN_DSP=25,HLS_SYN_FF=5265,HLS_SYN_LUT=3385}";
    ...
    signal Block_proc4_U0_num_outputs_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_proc4_U0_num_outputs_out_write : STD_LOGIC;
    signal Block_proc4_U0_num_inputs_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_proc4_U0_num_inputs_out_write : STD_LOGIC;
    signal Block_proc4_U0_batch_size_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_proc4_U0_batch_size_out_write : STD_LOGIC;
    ...
    signal Block_proc4_U0_ap_return_3 : STD_LOGIC_VECTOR (0 downto 0);
    signal Block_proc4_U0_ap_return_4 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_channel_done_tmp_6_loc_channel : STD_LOGIC;
    signal tmp_6_loc_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_tmp_6_loc_channel : STD_LOGIC := '0';
    ...
    signal ap_channel_done_tmp_1_loc_channel : STD_LOGIC;
    signal tmp_1_loc_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_tmp_1_loc_channel : STD_LOGIC := '0';
    signal ap_sync_channel_write_tmp_1_loc_channel : STD_LOGIC;
    signal ap_channel_done_tmp_2_loc_channel : STD_LOGIC;
    signal tmp_2_loc_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_tmp_2_loc_channel : STD_LOGIC := '0';
    ...
    signal Loop_batch_loop_proc_U0_num_outputs_read : STD_LOGIC;
    signal Loop_batch_loop_proc_U0_num_inputs_read : STD_LOGIC;
    ...
    signal tmp_4_loc_channel_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_4_loc_channel_empty_n : STD_LOGIC;
    signal tmp_6_loc_channel_dout : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    num_outputs_channel_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    num_inputs_channel_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    batch_size_channel_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    tmp_2_loc_channel_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    tmp_1_loc_channel_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    tmp_4_loc_channel_U : component fifo_w1_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    tmp_6_loc_channel_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_channel_write_tmp_1_loc_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
    ...
    ap_sync_reg_channel_write_tmp_2_loc_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
    ...
    ap_sync_reg_channel_write_tmp_6_loc_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
    ...
    Block_proc4_U0_ap_continue <= (ap_sync_channel_write_tmp_6_loc_channel and ap_sync_channel_write_tmp_4_loc_channel and ap_sync_channel_write_tmp_3_loc_channel and ap_sync_channel_write_tmp_1_loc_channel and ap_sync_channel_write_tmp_2_loc_channel);
    ...
    Loop_batch_loop_proc_U0_ap_start <= (ap_start and tmp_2_loc_channel_empty_n and tmp_1_loc_channel_empty_n and tmp_3_loc_channel_empty_n and tmp_4_loc_channel_empty_n and tmp_6_loc_channel_empty_n and (ap_sync_reg_Loop_batch_loop_proc_U0_ap_ready xor ap_const_logic_1));
    Loop_batch_loop_proc_U0_start_full_n <= ap_const_logic_0;
    Loop_batch_loop_proc_U0_start_write <= ap_const_logic_0;
    ap_channel_done_tmp_1_loc_channel <= (Block_proc4_U0_ap_done and (ap_sync_reg_channel_write_tmp_1_loc_channel xor ap_const_logic_1));
    ap_channel_done_tmp_2_loc_channel <= (Block_proc4_U0_ap_done and (ap_sync_reg_channel_write_tmp_2_loc_channel xor ap_const_logic_1));
    ...
    ap_channel_done_tmp_6_loc_channel <= (Block_proc4_U0_ap_done and (ap_sync_reg_channel_write_tmp_6_loc_channel xor ap_const_logic_1));
    ap_done <= Loop_batch_loop_proc_U0_ap_done;
    ap_idle <= (Block_proc4_U0_ap_idle and Loop_batch_loop_proc_U0_ap_idle and (tmp_2_loc_channel_empty_n xor ap_const_logic_1) and (tmp_1_loc_channel_empty_n xor ap_const_logic_1) and (tmp_3_loc_channel_empty_n xor ap_const_logic_1) and (tmp_4_loc_channel_empty_n xor ap_const_logic_1) and (tmp_6_loc_channel_empty_n xor ap_const_logic_1));
    ...
    ap_sync_channel_write_tmp_1_loc_channel <= ((ap_channel_done_tmp_1_loc_channel and tmp_1_loc_channel_full_n) or ap_sync_reg_channel_write_tmp_1_loc_channel);
    ap_sync_channel_write_tmp_2_loc_channel <= ((ap_channel_done_tmp_2_loc_channel and tmp_2_loc_channel_full_n) or ap_sync_reg_channel_write_tmp_2_loc_channel);
    ...
    ap_sync_channel_write_tmp_6_loc_channel <= ((ap_channel_done_tmp_6_loc_channel and tmp_6_loc_channel_full_n) or ap_sync_reg_channel_write_tmp_6_loc_channel);

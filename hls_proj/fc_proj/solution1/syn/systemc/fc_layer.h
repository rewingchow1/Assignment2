...
struct fc_layer : public sc_module {
    ...
    sc_signal< sc_lv<32> > Block_proc4_U0_num_outputs_out_din;
    sc_signal< sc_logic > Block_proc4_U0_num_outputs_out_write;
    sc_signal< sc_lv<32> > Block_proc4_U0_num_inputs_out_din;
    sc_signal< sc_logic > Block_proc4_U0_num_inputs_out_write;
    sc_signal< sc_lv<32> > Block_proc4_U0_batch_size_out_din;
    sc_signal< sc_logic > Block_proc4_U0_batch_size_out_write;
    ...
    sc_signal< sc_lv<1> > Block_proc4_U0_ap_return_3;
    sc_signal< sc_lv<64> > Block_proc4_U0_ap_return_4;
    sc_signal< sc_logic > ap_channel_done_tmp_6_loc_channel;
    sc_signal< sc_logic > tmp_6_loc_channel_full_n;
    sc_signal< sc_logic > ap_sync_reg_channel_write_tmp_6_loc_channel;
    sc_signal< sc_logic > ap_sync_channel_write_tmp_6_loc_channel;
    ...
    sc_signal< sc_logic > ap_channel_done_tmp_1_loc_channel;
    sc_signal< sc_logic > tmp_1_loc_channel_full_n;
    sc_signal< sc_logic > ap_sync_reg_channel_write_tmp_1_loc_channel;
    sc_signal< sc_logic > ap_sync_channel_write_tmp_1_loc_channel;
    sc_signal< sc_logic > ap_channel_done_tmp_2_loc_channel;
    sc_signal< sc_logic > tmp_2_loc_channel_full_n;
    sc_signal< sc_logic > ap_sync_reg_channel_write_tmp_2_loc_channel;
    sc_signal< sc_logic > ap_sync_channel_write_tmp_2_loc_channel;
    ...
    sc_signal< sc_logic > Loop_batch_loop_proc_U0_batch_size_read;
    sc_signal< sc_logic > Loop_batch_loop_proc_U0_num_outputs_read;
    sc_signal< sc_logic > Loop_batch_loop_proc_U0_num_inputs_read;
    ...
    sc_signal< sc_logic > num_outputs_channel_full_n;
    sc_signal< sc_lv<32> > num_outputs_channel_dout;
    sc_signal< sc_logic > num_outputs_channel_empty_n;
    sc_signal< sc_logic > num_inputs_channel_full_n;
    sc_signal< sc_lv<32> > num_inputs_channel_dout;
    sc_signal< sc_logic > num_inputs_channel_empty_n;
    sc_signal< sc_logic > batch_size_channel_full_n;
    sc_signal< sc_lv<32> > batch_size_channel_dout;
    sc_signal< sc_logic > batch_size_channel_empty_n;
    ...
    sc_signal< sc_lv<1> > tmp_4_loc_channel_dout;
    sc_signal< sc_logic > tmp_4_loc_channel_empty_n;
    sc_signal< sc_lv<64> > tmp_6_loc_channel_dout;
    sc_signal< sc_logic > tmp_6_loc_channel_empty_n;
    ...
    void thread_ap_channel_done_tmp_1_loc_channel();
    void thread_ap_channel_done_tmp_2_loc_channel();
    void thread_ap_channel_done_tmp_3_loc_channel();
    void thread_ap_channel_done_tmp_4_loc_channel();
    void thread_ap_channel_done_tmp_6_loc_channel();
    void thread_ap_done();
    void thread_ap_idle();
    ...
    void thread_ap_sync_channel_write_tmp_1_loc_channel();
    void thread_ap_sync_channel_write_tmp_2_loc_channel();
    void thread_ap_sync_channel_write_tmp_3_loc_channel();
    void thread_ap_sync_channel_write_tmp_4_loc_channel();
    void thread_ap_sync_channel_write_tmp_6_loc_channel();

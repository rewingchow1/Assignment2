...
#ifndef __fc_layer_fcmp_32ndEe__HH__
#define __fc_layer_fcmp_32ndEe__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fc_layer_fcmp_32ndEe) {
    ...
    SC_CTOR(fc_layer_fcmp_32ndEe):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);

...
#ifndef __fc_layer_mul_32nsfYi__HH__
#define __fc_layer_mul_32nsfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fc_layer_mul_32nsfYi) {
    ...
    SC_CTOR(fc_layer_mul_32nsfYi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

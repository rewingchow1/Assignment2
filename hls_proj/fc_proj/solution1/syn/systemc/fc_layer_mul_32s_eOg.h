...
#ifndef __fc_layer_mul_32s_eOg__HH__
#define __fc_layer_mul_32s_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fc_layer_mul_32s_eOg) {
    ...
    SC_CTOR(fc_layer_mul_32s_eOg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {

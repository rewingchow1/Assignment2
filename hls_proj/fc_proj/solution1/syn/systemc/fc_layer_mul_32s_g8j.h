...
#ifndef __fc_layer_mul_32s_g8j__HH__
#define __fc_layer_mul_32s_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fc_layer_mul_32s_g8j) {
    ...
    SC_CTOR(fc_layer_mul_32s_g8j):  ACMP_mul_su_U ("ACMP_mul_su_U") {
